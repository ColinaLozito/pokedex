...
import { usePokemonDetailsV2Screen } from './hooks/usePokemonDetailsV2Screen'

export default function PokemonDetailsV2Screen() {
  const router = useRouter()
  const scrollViewRef = useRef<ScrollView>(null)

  const { data, status, actions } = usePokemonDetailsV2Screen()
